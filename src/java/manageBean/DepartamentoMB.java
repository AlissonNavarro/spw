...
public class DepartamentoMB implements Serializable {
    ...
    public int inserir(String novoDepartamentoNome, Integer departamentoDestino) {
        int flag = 0;
        try {
    ...
    public int alterar(Departamento depto) {
        int flag = 0;
        try {
            String sql = "select deptName from Departments "
    ...
    public boolean excluir(Integer departamentoSelecionado) {
