...
public class folhaBean implements Serializable{
    ...
    public void consultar() {
        ...
        if (validarHora(hora)) {
            ...
            folhaList = banco.consultaDadosPonto(departamentoSelecionado, data, horaData);
            folhaList = getJornada(folhaList);

            List<folha> listaPresencaListFiltro = new ArrayList<folha>();
            ...
            folhaList = listaPresencaListFiltro;
        } else {
    ...
    public List<folha> getJornada(List<folha> folhaList) {
