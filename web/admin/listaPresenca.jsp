...
<html>
    ...
    <body>
        <f:view>
            ...
            <h:form>
                <a4j:keepAlive beanName="listaPresencaBean" />
                <a4j:keepAlive beanName="listaPresencaTotalBean" />
                <center>
                    <h:panelGrid columns="1" >
                        <center>
                            <rich:tabPanel switchType="client" width="965">
                                ...
                                <rich:tab id="tab2" label="Lista de Presença" rendered="#{usuarioBean.perfil.listaDePresenca == true}">
                                    <center>
                                ...
                                <rich:tab id="tab3" label="Consulta de irregulares" rendered="#{usuarioBean.perfil.consultaIrregulares == true}">
                                    <h:outputText value="Isto é uma aba"/>
                                </rich:tab>
                                <rich:tab id="tab4" label="Consulta de Hora Extra" rendered="#{usuarioBean.perfil.consultaHoraExtra == true}">
                                    <h:outputText value="Isto é outra aba"/>
                                </rich:tab>
                            </rich:tabPanel>
                        </h:panelGrid> <br/>
                        <h:panelGroup>
