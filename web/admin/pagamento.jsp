<%-- 
    Document   : pagamento
    Created on : 15/03/2012, 14:28:12
    Author     : mvgmjunior
--%>
                                    ...
                                    <center>
                                        <a4j:region id="region1">
                                            <h:panelGrid columns="1" >
                                                <rich:panel>
                                                    <center>
                                                        <h:panelGrid columns="2" >
                                                            <h:panelGrid columns="6" >
                                                                ...
                                                                <h:selectOneMenu id="deparIdT" value="#{folhaTotalBean.departamentoSelecionado}"  >
                                                                    <f:selectItems value="#{folhaTotalBean.departamentosSelecItem}"/>
                                                                    <a4j:support event="onchange" action="#{folhaTotalBean.consultaFuncionario}"/>
                                                                </h:selectOneMenu>
                                                                ...
                                                                <rich:calendar inputSize="8" id="dataIdT" locale="#{folhaTotalBean.objLocale}" value="#{folhaTotalBean.data}">
                                                                </rich:calendar>
                                                                <rich:spacer width="12"/>

                                                                <h:inputText id="horaT" size="3" value="#{folhaTotalBean.hora}">
                                                                    <rich:jQuery selector="#horaT" query="mask('99:99')" timing="onload"/>
                                                                </h:inputText>

                                                                <h:panelGroup>
                                                                    <rich:spacer width="12"/>
                                                                    <a4j:commandButton action="#{folhaTotalBean.consultar}" value="Pesquisar"
                                                                                       reRender="resumo,presencaListT,datascrollersT,panelPresenca">
                                                                    </a4j:commandButton>
                                                                </h:panelGroup>

                                                                <h:panelGroup>
                                                                    <h:selectBooleanCheckbox value="#{folhaTotalBean.incluirSubSetores}">
                                                                        <a4j:support event="onchange" action="#{folhaTotalBean.consultaFuncionario}"/>
                                                        ...
                                                        <rich:modalPanel id="filtroFuncionarioListaPresencaModalPanel" width="750" height="250"  style="text-align:center;float:center;" >
                                                            ...
                                                            <center>
                                                                <fieldset class="demo_fieldset" >
                                                                    ...
                                                                    <h:panelGroup >
                                                                        <h:selectOneRadio
                                                                            value="#{folhaTotalBean.regimeSelecionadoOpcaoFiltroFuncionario}" >
                                                                            <f:selectItems
                                                                                value="#{folhaTotalBean.regimeOpcaoFiltroFuncionarioList}"/>
                                                                        </h:selectOneRadio>
                                                                    </h:panelGroup>
                                                                </fieldset>
                                                                <br>
                                                                <fieldset class="demo_fieldset" >
                                                                    ...
                                                                    <h:panelGroup>
                                                                        <h:selectOneRadio
                                                                            value="#{folhaTotalBean.tipoGestorSelecionadoOpcaoFiltroFuncionario}" >
                                                                            <f:selectItems
                                                                                value="#{folhaTotalBean.gestorFiltroFuncionarioList}"/>
                                                                        </h:selectOneRadio>
                                                                    </h:panelGroup>
                                                                </fieldset>
                                                                <br> <br>                                                                
                                                                <h:commandButton value="Confirmar" id="confirmarOpcaoFiltroRegimeListaPresenca"
                                                                                 action="#{folhaTotalBean.consultaFuncionario}">
                                                    ...
                                                    <center>
                                                        <h:selectOneRadio
                                                            value="#{folhaTotalBean.filtroSelecionado}">
                                                            <f:selectItems
                                                                value="#{folhaTotalBean.filtroSelecItem}" />
                                                        </h:selectOneRadio>                                                       
                                            ...
                                            <center>
                                                <h:panelGroup id="pesquisa" >
                                                    ...
                                                    <rich:spacer width="7"/>
                                                    <h:inputText value="#{folhaTotalBean.filtroNomePesquisa}" id="input" size="40">
                                                        <a4j:support event="onkeyup" reRender="resumo,presencaListT,datascrollersT,panelPresenca"
                                                                     ...
                                                                     action="#{folhaTotalBean.consultar}"/>
                                                    </h:inputText>
                                                </h:panelGroup>
                                                <br/> 
                                                <h:panelGroup id="resumo" >
                                                    <center>
                                                        <h:panelGrid rendered="#{not empty folhaTotalBean.listaPresencaList}" columns="2">
                                                            <h:panelGrid columns="18" styleClass="resumo" >
                                                                <h:outputText value="Total de Funcionários: " styleClass="label"/>
                                                                <h:outputText value="#{folhaTotalBean.totalFuncionarios}"/>
                                                                <rich:spacer width="15"/>
                                                                <h:outputText value="Funcionários Presentes: " styleClass="label"/>
                                                                <h:outputText value="#{folhaTotalBean.totalPresentes}"/>
                                                                <rich:spacer width="15"/>
                                                                <h:outputText value="Funcionários Ausentes " styleClass="label"/>
                                                                <h:outputText value=" #{folhaTotalBean.totalAusentes}"/>
                                                            </h:panelGrid>
                                                            <h:panelGroup>
                                                                <rich:spacer width="15"/>
                                                                <h:commandLink action="#{folhaTotalBean.imprimir}" rendered="#{not empty folhaTotalBean.listaPresencaList}">
                                        ...
                                        <h:panelGroup id="panelPresenca" >
                                            <rich:dataTable id="presencaListT"                                                            
                                                            ...
                                                            value="#{folhaTotalBean.listaPresencaList}" var="linha"
                                                            rendered="#{not empty folhaTotalBean.listaPresencaList}"
                                                            rows="25">
                                                <f:facet name="header">
